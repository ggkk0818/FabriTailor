...
[@seo type = "productContent"]
	<title>[#if product.seoTitle??]${product.seoTitle}[#elseif seo.title??][@seo.title?interpret /][/#if][#if systemShowPowered] - 凡布[/#if]</title>
...
<body>
        ...
        <div class="product-customizations">
            ...
            <div class="customization add-to-cart" style="height:500px;">
                <div class="zoom-container" style="display:block;">
                    ...
                    <a class="btn left" href="javascript:void(0);">继续购物</a>
                    <a class="btn right" href="${base}/member/order/infov2.jhtml">查看购物车</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        var productCustomizationBuildInit = function () {
            ...
            //放入购物车成功后返回
            $(".main-container .product-customizations .customization").last().find("a.btn.left").click(productCustomizationBuildAddToCartReturn);
